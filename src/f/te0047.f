...
C     NBVIN11: 14 VARIABLES INTERNES
      ...
      PARAMETER   (NBRE11  = 2*6 , NBVIN11 = 14)
...
C        LOI 11 ISOTROPE 3D      NBRE11 = 2 PARAMETRES PAR COMPOSANTE
      INTEGER      NBPARA
...
C        IL EST DONC ELASTIQUE DANS CETTE DIRECTION. ==> DINONC
         ...
         CALL R8INIR(6*NBPARA, MOINS1,  COEFLO, 1)
C --- -- EXAMEN DES CODRE7, VALRE7. ON AFFECTE RAIDE, LES PARAMETRES
         CALL DINONC3D(NOMTE,CODRE11,VALRE11,KLV,RAIDE,NBPARA,COEFLO,2)
C --- -- LOI DE COMPORTEMENT NON-LINEAIRE
         CALL R8INIR(NBVINT, ZERO, VARDNL, 1)
