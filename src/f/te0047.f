...
C ----------------------------------------------------------------------
      ...
      INTEGER     IADZI,IAZK24,IBID,INFODI
...
C     VALRE3 : VALEUR PARAMETRES DE LA LOI
C     NOMRE3 : NOM DES PARAMETRES DE LA LOI
      REAL*8       VALRE3(NBRE3)
...
C     LOI ISOTROPE SUR 6 COMPOSANTES : DIS_ECRO_ISO
C     NBRE7  : 4 PARAMETRES PAR COMPOSANTE
C     NBVIN7 : 26 VARIABLES INTERNES
      INTEGER      NBRE7, NBVIN7
      PARAMETER   (NBRE7  = 4*6 , NBVIN7 = 26)
C     VALRE7 : VALEUR PARAMETRES DE LA LOI
C     NOMRE7 : NOM DES PARAMETRES DE LA LOI
      REAL*8       VALRE7(NBRE7)
      INTEGER      CODRE7(NBRE7)
      CHARACTER*8  NOMRE7(NBRE7)

C     LOI CINEMATIQUE SUR 6 COMPOSANTES : DIS_ECRO_CINE3D
C     NBRE10 : 4 PARAMETRES PAR COMPOSANTE
C     NBVIN10: 26 VARIABLES INTERNES
      INTEGER      NBRE10, NBVIN10
      PARAMETER   (NBRE10  = 4*6 , NBVIN10 = 26)
C     VALRE10 : VALEUR PARAMETRES DE LA LOI
C     NOMRE10 : NOM DES PARAMETRES DE LA LOI
      REAL*8       VALRE10(NBRE10)
      INTEGER      CODRE10(NBRE10)
      CHARACTER*8  NOMRE10(NBRE10)

C     LOI ISOTROPE SUR 6 COMPOSANTES : DIS_ECRO_ISO3D
C     NBRE11 : 2 PARAMETRES PAR COMPOSANTE
C     NBVIN11: 14 VARIABLES INTERNES
      INTEGER      NBRE11, NBVIN11
      PARAMETER   (NBRE11  = 4*6 , NBVIN11 = 14)
C     VALRE11 : VALEUR PARAMETRES DE LA LOI
C     NOMRE11 : NOM DES PARAMETRES DE LA LOI
      REAL*8       VALRE11(NBRE11)
      INTEGER      CODRE11(NBRE11)
      CHARACTER*8  NOMRE11(NBRE11)
...
C        LOI  7 ISOTROPE         NBRE7  = 4 PARAMETRES PAR COMPOSANTE
C        LOI 10 CINEMATIQUE 3D   NBRE10 = 4 PARAMETRES PAR COMPOSANTE
C        LOI 11 ISOTROPE 3D      NBRE11 = 4 PARAMETRES PAR COMPOSANTE
      INTEGER      NBPARA
...
C        LOI  2 VISQUEUX         NBVIN2 = 2*6 : F+  Energie
C        LOI  3 CINEMATIQUE      NBVIN3 = 3*6 : Uan  alpha  Energie
C        LOI  4 BILINIAIRE       NBVIN4 = 1*6 : indicateur
C        LOI  7 ISOTROPE         NBVIN7 = 26  : ...
C        LOI 10 CINEMATIQUE 3D   NBVIN10= 26  : ...
C        LOI 11 ISOTROPE 3D      NBVIN11= 14  : ...
      INTEGER      NBVINT,NUMLOI
      PARAMETER   (NBVINT = NBVIN7)
...
C     LOI 7 : ISOTROPE          NBRE7  : 4 PARAMETRES PAR COMPOSANTE
      DATA NOMRE7  /'FY_DX','H_DX','A_DX','DUMMY_DX',
     &              'FY_DY','H_DY','A_DY','DUMMY_DY',
     &              'FY_DZ','H_DZ','A_DZ','DUMMY_DZ',
     &              'FY_RX','H_RX','A_RX','DUMMY_RX',
     &              'FY_RY','H_RY','A_RY','DUMMY_RY',
     &              'FY_RZ','H_RZ','A_RZ','DUMMY_RZ'/
C     LOI 10: CINEMATIQUE 3D    NBRE10  : 4 PARAMETRES PAR COMPOSANTE
      DATA NOMRE10 /'FY_DX','H_DX','A_DX','DUMMY_DX',
     &              'FY_DY','H_DY','A_DY','DUMMY_DY',
     &              'FY_DZ','H_DZ','A_DZ','DUMMY_DZ',
     &              'FY_RX','H_RX','A_RX','DUMMY_RX',
     &              'FY_RY','H_RY','A_RY','DUMMY_RY',
     &              'FY_RZ','H_RZ','A_RZ','DUMMY_RZ'/
C     LOI 11: ISOTROPE 3D       NBRE11  : 3 PARAMETRES PAR COMPOSANTE
      DATA NOMRE11 /'FY_DX','CI_DX','N_DX','FU_DX',
     &              'FY_DY','CI_DY','N_DY','FU_DY',
     &              'FY_DZ','CI_DZ','N_DZ','FU_DZ',
     &              'FY_RX','CI_RX','N_RX','FU_RX',
     &              'FY_RY','CI_RY','N_RY','FU_RY',
     &              'FY_RZ','CI_RZ','N_RZ','FU_RZ'/
...
C                       12345678901234   12345678901234
C     ZK16(ICOMPO)      ELAS             DIS_GRICRA
C                       DIS_VISC         DIS_ECRO_CINE
C                       DIS_BILI_ELAS    ASSE_CORN
C                       ARME             DIS_CHOC
C                       DIS_GOUJ2E       DIS_ECRO_ISO
...
C ======================================================================
C            DEBUT COMPORTEMENT DIS_ECRO_ISO : DISCRET_NON_LINE
C ======================================================================
      IF (ZK16(ICOMPO).EQ.'DIS_ECRO_ISO') THEN
C ------ RECUPERATION DU MATERIAU
         CALL JEVECH('PMATERC','L',IMATE)
...
C ------ RECUPERATION DES CARACTERISTIQUES
         ...
         VALPA = 0.D0
C --- -- RECUPERE TOUS LES PARAMETRES
         CALL R8INIR(NBRE7,ZERO,VALRE7,1)
         CALL RCVALA(ZI(IMATE),' ','DIS_ECRO_ISO',NBPAR,NOMPA,VALPA,
     &               NBRE7,NOMRE7,VALRE7,CODRE7,0)
...
C        IL EST DONC ELASTIQUE DANS CETTE DIRECTION. ==> DINONC
         CALL R8INIR(6, ZERO,  RAIDE, 1)
         CALL R8INIR(6*NBPARA, MOINS1,  COEFLO, 1)
C --- -- EXAMEN DES CODRE7, VALRE7. ON AFFECTE RAIDE, LES PARAMETRES
         CALL DINONC3D(NOMTE,CODRE7,VALRE7,KLV,RAIDE,NBPARA,COEFLO,4)
C --- -- LOI DE COMPORTEMENT NON-LINEAIRE
         CALL R8INIR(NBVINT, ZERO, VARDNL, 1)
         CALL DINON7(NEQ,ULM,DUL,ULP,NNO,
     &               NC,NBVIN7,ZR(IVARIM),RAIDE,NBPARA,COEFLO,
     &               VARDNL)
...
C        ET MISE A JOUR DES VARIABLES INTERNES
     ...
     &                  NUMLOI,VARDNL)
            DO 127 II = 1 , NBVIN7
               ZR(IVARIP+II-1) = VARDNL(II)
127         CONTINUE
            WRITE(6,*) "CONTP = ",ZR(ICONTP)
         ENDIF
         GOTO 800
      ENDIF
C ======================================================================
C              FIN COMPORTEMENT ISOTROPE DISCRET_NON_LINE
C ======================================================================

C ======================================================================
C            DEBUT COMPORTEMENT DIS_ECRO_CINE3D : DISCRET_NON_LINE
C ======================================================================
      IF (ZK16(ICOMPO).EQ.'DIS_ECRO_CINE3D') THEN
C ------ RECUPERATION DU MATERIAU
         CALL JEVECH('PMATERC','L',IMATE)
...
C ------ RECUPERATION DES CARACTERISTIQUES
         ...
         VALPA = 0.D0
C --- -- RECUPERE TOUS LES PARAMETRES
         CALL R8INIR(NBRE10,ZERO,VALRE10,1)
         CALL RCVALA(ZI(IMATE),' ','DIS_ECRO_CINE3D',NBPAR,NOMPA,VALPA,
     &               NBRE10,NOMRE10,VALRE10,CODRE10,0)
...
C        IL EST DONC ELASTIQUE DANS CETTE DIRECTION. ==> DINONC
         CALL R8INIR(6, ZERO,  RAIDE, 1)
         CALL R8INIR(6*NBPARA, MOINS1,  COEFLO, 1)
C --- -- EXAMEN DES CODRE10, VALRE10. ON AFFECTE RAIDE, LES PARAMETRES
         CALL DINONC3D(NOMTE,CODRE10,VALRE10,KLV,RAIDE,NBPARA,COEFLO,4)
C --- -- LOI DE COMPORTEMENT NON-LINEAIRE
         CALL R8INIR(NBVINT, ZERO, VARDNL, 1)
         CALL DINON10(NEQ,ULM,DUL,ULP,NNO,
     &               NC,NBVIN10,ZR(IVARIM),RAIDE,NBPARA,COEFLO,
     &               VARDNL)
...
C ======================================================================
C            DEBUT COMPORTEMENT DIS_ECRO_ISO3D : DISCRET_NON_LINE
C ======================================================================
      IF (ZK16(ICOMPO).EQ.'DIS_ECRO_ISO3D') THEN
C ------ RECUPERATION DU MATERIAU
         CALL JEVECH('PMATERC','L',IMATE)
...
C ------ RECUPERATION DES CARACTERISTIQUES
         ...
         VALPA = 0.D0
C --- -- RECUPERE TOUS LES PARAMETRES
         CALL R8INIR(NBRE11,ZERO,VALRE11,1)
         CALL RCVALA(ZI(IMATE),' ','DIS_ECRO_ISO3D',NBPAR,NOMPA,VALPA,
     &               NBRE11,NOMRE11,VALRE11,CODRE11,0)
...
C        IL EST DONC ELASTIQUE DANS CETTE DIRECTION. ==> DINONC
         ...
         CALL R8INIR(6*NBPARA, MOINS1,  COEFLO, 1)
C --- -- EXAMEN DES CODRE7, VALRE7. ON AFFECTE RAIDE, LES PARAMETRES
         CALL DINONC3D(NOMTE,CODRE11,VALRE11,KLV,RAIDE,NBPARA,COEFLO,4)
C --- -- LOI DE COMPORTEMENT NON-LINEAIRE
         CALL R8INIR(NBVINT, ZERO, VARDNL, 1)
         CALL DINON11(NEQ,ULM,DUL,ULP,NNO,
     &               NC,NBVIN11,ZR(IVARIM),RAIDE,NBPARA,COEFLO,
     &               VARDNL)
...
C        ET MISE A JOUR DES VARIABLES INTERNES
     ...
     &                  KLV,DUL,ZR(ICONTM),ZR(ICONTP),ZR(IFONO),
     &                  NUMLOI,VARDNL)
            DO 1211 II = 1 , NBVIN11
               ZR(IVARIP+II-1) = VARDNL(II)
1211        CONTINUE
            WRITE(6,*) "CONTP = ",ZR(ICONTP:ICONTP+1)
         ENDIF
         GOTO 800
      ENDIF
C ======================================================================
...
C ---    RELATION DE COMPORTEMENT DE L'ARMEMENT
     ...
     &               ZR(IVARIM),KLV,VARIP,FORCE(1),DULY)
C ---    ACTUALISATION DE LA MATRICE TANGENTE
         IF ( OPTION.EQ.'FULL_MECA' .OR.
     &        OPTION.EQ.'RIGI_MECA_TANG' ) THEN
            CALL JEVECH('PMATUUR','E',IMAT)
