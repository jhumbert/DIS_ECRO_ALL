#@ AJOUT dis_ecro_cine3d Comportement  DATE 07/12/2010   AUTEUR HUMBERT J.HUMBERT 
# -*- coding: iso-8859-1 -*-
...
loi = LoiComportement(
   nom            = 'DIS_ECRO_CINE3D',
   doc            = """Relation de comportement à écrouissage cinématique 3D exacte (return-mapping) des éléments discrets""",
   num_lc         = 9999,
   nb_vari        = 26,
   nom_vari       = (
